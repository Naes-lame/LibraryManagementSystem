...
public class UsersController {
    ...
    public static Users getUserByUsername(String username) {
        Users user = null;
        try (Connection conn = SQLDatabaseManager.getConnection(); PreparedStatement stmt = conn.prepareStatement("SELECT * FROM user WHERE username = ?")) {
    ...
    public static String getHashedPassword(int userId) {
        try {
            Connection conn = SQLDatabaseManager.getConnection();
