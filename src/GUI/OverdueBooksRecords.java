...
public class OverdueBooksRecords extends javax.swing.JFrame implements imagesNbuttons{
    ...
    private void initComponents() {
        ...
        OverdueBooksTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Transaction ID", "Borrower ID", "Book ID", "Issue Date", "Due Date", "Days Overdue", "Fine Amount", "Status"
            }
        ) {
        ...
        jScrollPane1.setViewportView(OverdueBooksTable);
        if (OverdueBooksTable.getColumnModel().getColumnCount() > 0) {
            OverdueBooksTable.getColumnModel().getColumn(0).setResizable(false);
            OverdueBooksTable.getColumnModel().getColumn(1).setResizable(false);
            OverdueBooksTable.getColumnModel().getColumn(2).setResizable(false);
            OverdueBooksTable.getColumnModel().getColumn(3).setResizable(false);
            OverdueBooksTable.getColumnModel().getColumn(4).setResizable(false);
            OverdueBooksTable.getColumnModel().getColumn(5).setResizable(false);
            OverdueBooksTable.getColumnModel().getColumn(6).setResizable(false);
            OverdueBooksTable.getColumnModel().getColumn(7).setResizable(false);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OverdueBooksRecords.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OverdueBooksRecords().setVisible(true);
            }
        });
    }
